...
<?php $holiday = $this->db->get_where('holiday', array('holi_start_month'=> $month, 'holi_start_year'=> $sessional_year))->result_array(); 
$holiday_list = [];
$end_date = [];
$k = 0;
		...
		<table class = "table table-bordered" id = "my_table">
			...
			?>
					<td>
						...
						if($i >= $holiday_list[$j] && $i <= $end_date[$j] ){
						 
						?>
				<p style = "color:red;"><?php echo $i; 
							if($i == $end_date[$j]){
								$j++;
							}
					?></p>
						...
						<p style = "color:black;"><?php echo $i; ?></p>
