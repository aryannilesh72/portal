...
<div class = "container">
	...
	<div class = "row">
		...
		<form method = "post" action="<?php echo site_url('login/update_employee/'.$user_id);?>" enctype= "multipart/form-data">
    ...
    <input type="file" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp" name = "photo">
                         ...
                         <div class="col-lg-3 input_field_sections form-group">
								...
								<input type="text" class="form-control " name="pan_no" value="<?php echo $row['pan_no']; ?>"/>
                          </div>
                          <div class="col-lg-3 input_field_sections form-group">
                                <h5>Verify Pan No: <span style="color: #cc0000">*</span></h5>
								<select  name="verify_pan" class="form-control designation">
                             ...
                             <div class="col-lg-3 input_field_sections form-group">
								...
								<select  name="verify_aadhar" class="form-control designation">
                             ...
                             <div class="col-lg-3 input_field_sections form-group">
								...
								<select  name="verify_account" class="form-control designation">
                              ...
                              <div class="col-lg-3 input_field_sections form-group">
								...
								<input type="text" class="form-control " name="ifsc_code" value="<?php echo $row['ifsc_code']; ?>"/>
                          </div>
                          <div class="col-lg-3 input_field_sections form-group">
                                <h5>Verify IFSC Code: <span style="color: #cc0000">*</span></h5>
								<select  name="verify_ifsc" class="form-control designation">
